        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <div className="mt-6 flex gap-2">
              <a href="https://x.com/Hard_patel_201" target="_blank">
              ...
              <a
                href="https://github.com/HardPatel2005"
                target="_blank"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="https://www.wix.com/blog/blog-niche-ideas"
                  target="_blank"
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  Topics
              ...
              <li>
                <a
                  href="https://blog.reedsy.com/guide/author-websites/"
                  target="_blank"
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  Authors
              ...
              <li>
                <a
                  href="https://riverside.fm/blog/podcast-websites/"
                  target="_blank"
                  className="text-muted-foreground hover:text-foreground transition-colors"
                >
                  Podcasts
